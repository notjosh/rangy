...
function iterateNodes(node, func, includeSelf) {
  ...
  for (
    var i = 0, children = node.childNodes, len = children.length;
    i < len;
    ++i
  ) {
      ...
      if (node.nodeType == 3) {
        ...
        if (openBracketIndex != -1) {
          node.data =
            ...
            node.data.slice(openBracketIndex + 1);
        ...
        if (closeBracketIndex != -1) {
          node.data =
            ...
            node.data.slice(closeBracketIndex + 1);
...
function canHaveChildren(el) {
  return !/^(area|base|basefont|br|col|frame|hr|img|input|isindex|link|meta|param)$/i.test(
    el.nodeName
  );
}
...
function htmlAndRangeToString(containerEl, range) {
  ...
  function getHtml(node, includeSelf) {
    ...
    if (node.nodeType == 1) {
      ...
      for (
        i = 0, children = node.childNodes, len = children.length;
        i <= len;
        ++i
      ) {
...
QUnit.test('Test unapply to range spanning two blocks', function (t) {
  ...
  t.equal(
    '<p><span class="c1">[One</span></p><div class="key"><span class="c1">Two]</span></div>',
...
QUnit.test('Test issue 50 (Mac double click)', function (t) {
  ...
  applier.applyToRange(range);
  t.equal(
    '<b><span class="c1">[one]</span></b> two',
    htmlAndRangeToString(testEl, range)
  );
});
...
QUnit.test(
  ...
  function (t) {
    ...
    t.equal(
      'T<span class="c1">h</span><span class="c2">[r]</span><span class="c1">e</span>e',
      htmlAndRangeToString(testEl, range)
    );
  }
);
...
QUnit.test(
  ...
  function (t) {
    ...
    applier1.toggleRange(range);
    t.equal(
      '<b>One</b> T<span class="c1">h</span><span class="c2">[r]</span><span class="c1">e</span>e',
      htmlAndRangeToString(testEl, range)
    );
  }
);
...
QUnit.test(
  ...
  function (t) {
    ...
    applier1.toggleRange(range);
    t.equal(
      'T<span class="c1">h<span class="c2">r</span></span><span class="c2">[r]</span><span class="c1"><span class="c2">r</span>e</span>e',
      htmlAndRangeToString(testEl, range)
    );
  }
);
...
QUnit.test('Test whitespace 4 (pre whitespace between paras)', function (t) {
  ...
  applier.applyToRange(range);
  t.equal(
    'x<div><p><span class="c1">[1</span></p><span class="c1"> </span><p><span class="c1">2]</span></p></div>x',
    htmlAndRangeToString(testEl, range)
  );
});
...
QUnit.test('Test whitespace 5 (normal whitespace between paras)', function (t) {
  ...
  applier.applyToRange(range);
  t.equal(
    'x<div><p><span class="c1">[1</span></p> <p><span class="c1">2]</span></p></div>x',
    htmlAndRangeToString(testEl, range)
  );
});
...
QUnit.test(
  ...
  function (t) {
    ...
    applier.applyToRange(range);
    t.equal(
      'x<div><p><span class="c1">[1</span></p><span class="c1">\n</span><p><span class="c1">2]</span></p></div>x',
      htmlAndRangeToString(testEl, range)
    );
  }
);
...
QUnit.test('Test removal of element with elementProperties', function (t) {
  ...
  applier.undoToRange(range);
  t.equal(
    '[1<a href="http://www.timdown.co.uk/">2</a><span class="c1">3</span>4]5',
    htmlAndRangeToString(testEl, range)
  );
});
...
QUnit.test('Test adding extra class', function (t) {
  ...
  applier.toggleRange(range);
  t.equal(
    't<span class="c1 extra">[es]</span>t',
    htmlAndRangeToString(testEl, range)
  );
...
QUnit.test('Test adding extra class with overlapping containers', function (t) {
  ...
  applier2.applyToRange(range);
  t.equal(
    't<span class="c1 c2 extra">[es]</span>t',
    htmlAndRangeToString(testEl, range)
  );
});
...
QUnit.test('Issue 111 (extra option for useExistingElements)', function (t) {
  ...
  applier.applyToRange(range);
  t.equal(
    'x<span class="c1">[1</span><span class="c1 c2">2</span><span class="c1">3]</span>x',
    htmlAndRangeToString(testEl, range)
  );
  applier.undoToRange(range);
  t.equal(
    'x[1<span class="c2">2</span>3]x',
    htmlAndRangeToString(testEl, range)
  );
  ...
  applier.applyToRange(range);
  t.equal(
    'x<span class="c1">[1</span><span class="c2"><span class="c1">2</span></span><span class="c1">3]</span>x',
    htmlAndRangeToString(testEl, range)
  );
  applier.undoToRange(range);
  t.equal(
...
QUnit.test('Issue 139 (Merge bug)', function (t) {
  ...
  applier.applyToRange(range);
  t.equal(
    '<div><span class="test">[1 2]</span></div>',
    htmlAndRangeToString(testEl, range)
  );
});
...
QUnit.test(
  ...
  function (t) {
    ...
    t.ok(applier.isAppliedToRange(range));
    range = createRangeInHtml(
      testEl,
      '<span class="test">one [<img src="fake.png">] two</span>'
    );
    t.ok(applier.isAppliedToRange(range));
  }
);
...
QUnit.test(
  ...
  function (t) {
    ...
    applier.applyToRange(range);
    t.equal(
      '1<span class="test">[2</span><style>.cheese { color: yellow; }</style><span class="test">3]</span>4',
      htmlAndRangeToString(testEl, range)
    );
  }
);
