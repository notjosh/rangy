...
rangy.createModule("TextRange", ["WrappedSelection"], function (api, module) {
  ...
  //     options.characterOptions = createOptions(
  ...
  //     getComputedStyleProperty(table, "display") == "block";
  ...
  //     if (
  //       ancestors[i].nodeType == 1 &&
  //       getComputedDisplay(ancestors[i]) == "none"
  //     ) {
  //       return true;
  //     }
  //   }
  ...
  //     node &&
  //     ((node.nodeType == 1 &&
  //       !/^(inline(-block|-table)?|none)$/.test(getComputedDisplay(node))) ||
  //       node.nodeType == 9 ||
  //       node.nodeType == 11)
  //   );
  // }
  ...
  //     return false;
  //   }
  //   var computedWhiteSpace = getComputedStyleProperty(
  //     node.parentNode,
  //     "whiteSpace"
  //   );
  ...
  //       var value = func.call(
  //         this,
  //         objProperty ? this[objProperty] : this,
  //         args
  //       );
  ...
  //       positions.set(offset, new Position(this, offset))
  //     );
  //   },
  ...
  // extend(nodeProto, {
  //   isCharacterDataNode: createCachingGetter(
  //     "isCharacterDataNode",
  //     dom.isCharacterDataNode,
  //     "node"
  //   ),
  //   getNodeIndex: createCachingGetter("nodeIndex", dom.getNodeIndex, "node"),
  //   getLength: createCachingGetter("nodeLength", dom.getNodeLength, "node"),
  //   containsPositions: createCachingGetter(
  //     "containsPositions",
  //     containsPositions,
  //     "node"
  //   ),
  //   isWhitespace: createCachingGetter("isWhitespace", isWhitespaceNode, "node"),
  //   isCollapsedWhitespace: createCachingGetter(
  //     "isCollapsedWhitespace",
  //     isCollapsedWhitespaceNode,
  //     "node"
  //   ),
  //   getComputedDisplay: createCachingGetter(
  //     "computedDisplay",
  //     getComputedDisplay,
  //     "node"
  //   ),
  ...
  //   getTextNodeInfo: createCachingGetter(
  //     "textNodeInfo",
  //     function (textNode) {
  //       log.debug("getTextNodeInfo for " + textNode.data);
  //       var spaceRegex = null,
  //         collapseSpaces = false;
  //       var cssWhitespace = getComputedStyleProperty(
  //         textNode.parentNode,
  //         "whiteSpace"
  //       );
  ...
  //   hasInnerText: createCachingGetter(
  //     "hasInnerText",
  //     function (el, backward) {
  ...
  //   isRenderedBlock: createCachingGetter(
  //     "isRenderedBlock",
  //     function (el) {
  ...
  //   getTrailingSpace: createCachingGetter(
  //     "trailingSpace",
  //     function (el) {
  ...
  //   getLeadingSpace: createCachingGetter(
  //     "leadingSpace",
  //     function (el) {
  //       switch (this.getComputedDisplay()) {
  //         case "inline":
  ...
  //       var trailingSpace = this.session
  ...
  //         log.debug(
  //           "nextPos: " + (nextPos ? nextPos.inspect() : "non-existent")
  //         );
  //         if (nextPos) {
  //           if (nextPos.isBr) {
  ...
  //       log.debug(
  //         "Character " + character + " is ignored in character options"
  //       );
  //       character = "";
  //     }

  //     log.debug(
  //       "getCharacter got '" + character + "' for pos " + this.inspect()
  //     );
  //     log.groupEnd();
  ...
  //         var wrappersByProperty =
  //           cache.get(property) || cache.set(property, []);
  //         wrappersByProperty.push(nodeWrapper);
  //       },
  //     };
  //   }

  //   var uniqueIDSupported = util.isHostProperty(
  ...
  //   Session.prototype = {
  //     initCaches: function () {
  //       this.elementCache = uniqueIDSupported
  //         ? (function () {
  ...
  //       default:
  //         throw new Error(
  //           "movePositionBy: unit '" + unit + "' not implemented"
  //         );
  //     }
  ...
  //       session.getRangeBoundaryPosition(this, boundaryIsStart),
  //       unit,
  //       count,
  ...
  //         session,
  //         this,
  //         createOptions(characterOptions, defaultCharacterOptions)
  //       ).join("");
  // }),

  // selectCharacters: createEntryPointFunction(function (
  //   session,
  //   containerNode,
  //   startIndex,
  //   endIndex,
  ...
  // toCharacterRange: createEntryPointFunction(function (
  //   session,
  //   containerNode,
  //   characterOptions
  // ) {
  ...
  // findText: createEntryPointFunction(function (
  //   session,
  //   searchTermParam,
  //   findOptions
  // ) {
  ...
  extend(api.selectionPrototype, {
    ...
    // }),
    // saveCharacterRanges: createEntryPointFunction(function (
    //   session,
    //   containerNode,
    //   characterOptions
    // ) {
    ...
    //   return rangeInfos;
    // }),
    // restoreCharacterRanges: createEntryPointFunction(function (
    //   session,
    //   containerNode,
    //   saved
    // ) {
